...
public class PointCP5Test
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
        if(args[0].toUpperCase().charAt(0) == 'C') {
        	point = new PointCPCart(args[0].toUpperCase().charAt(0), 
        			Double.valueOf(args[1]).doubleValue(), 
        			Double.valueOf(args[2]).doubleValue());
     
        }else {
        	point = new PointCPPolar(args[0].toUpperCase().charAt(0), 
        			Double.valueOf(args[1]).doubleValue(), 
  ...
  private static PointCP5 getInput() throws IOException
  {
    ...
    if(coordType == 'C') {
    	return (new PointCPCart(coordType, a, b));
  
    }
     return (new PointCPPolar(coordType, a, b));
  }
}
